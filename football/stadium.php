...
body{
    ...
    min-height: 100vh;
    background: url(Media/stadium.jpg);
...
<div id="headder">
  ...
  <h2><font color="#0000FF">Stadium details</font>&nbsp; &nbsp; &nbsp;<a href="stadiumdata.php" class="blink"><span>Click here to see stadium data</span></a></h2>
