...
body{
    ...
    min-height: 100vh;
    background: url(Media/manager.jpg);
...
<div id="headder">
  ...
  <h2><font color="#FFFFE0">Manager details</font>&nbsp; &nbsp; &nbsp;<a href="managerdata.php" class="blink"><span>Click here to see manager data</span></a></h2>
